...
// File ini DI-GUNAKAN OLEH file-file dalam folder admin/*/
// Contoh: admin/index.php, admin/siswa/list.php
// Path relatif dari file-file tsb ke sini adalah '../includes/'

// 1. Include auth check dan pastikan user adalah admin
include_once __DIR__ . '/auth_check.php'; // __DIR__ adalah path ke folder 'includes'
checkRole('admin'); // Hanya admin yang boleh mengakses

// 2. Pastikan fungsi yang dibutuhkan ada
if (!function_exists('getUserName')) {
    die("Error: Fungsi getUserName tidak ditemukan.");
}
if (!function_exists('getUserRole')) {
    die("Error: Fungsi getUserRole tidak ditemukan.");
}
...
// 4. Mulai output HTML
// Path CSS relatif terhadap file yang MEMANGGIL admin_header.php
// Karena file-file admin berada di admin/*/, maka path ke root adalah '../'
// Jadi, path ke assets/css/style.css adalah '../assets/css/style.css'
?>
<!DOCTYPE html>
<html lang="id">
<head>
