            ...
            <div class="sidebar">
                ...
                <div class="p-3">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link <?php echo (isset($active_page) && $active_page == 'dashboard') ? 'active' : ''; ?>" href="../guru/index.php">
                                <i class="fas fa-home me-2"></i>Dashboard
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo (isset($active_page) && $active_page == 'nilai') ? 'active' : ''; ?>" href="../guru/nilai/list.php">
                                <i class="fas fa-chart-line me-2"></i>Nilai Siswa
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo (isset($active_page) && $active_page == 'absensi') ? 'active' : ''; ?>" href="../guru/absensi/list.php">
